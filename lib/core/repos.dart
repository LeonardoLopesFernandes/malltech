...
class ConfigRepo {
  ...
  static Future<void> definirImagem(Map<String, dynamic> arquivo) =>
      Api.postBackendJson('/api/v1/usuarios/imagem', arquivo);

  static Future<void> removerImagem() =>
      Api.deleteBackend('/api/v1/usuarios/imagem/remove');
